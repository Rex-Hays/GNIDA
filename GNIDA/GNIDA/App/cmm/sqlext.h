...
extern WINAPI "odbc32.dll" {
	SQLRETURN SQLDriverConnect(SQLHDBC hdbc,SQLHWND hwnd,dword szConnStrIn,SQLSMALLINT cbConnStrIn,
		dword szConnStrOut,SQLSMALLINT cbConnStrOutMax,dword pcbConnStrOut,SQLUSMALLINT fDriverCompletion);
}
#endif /* RC_INVOKED */
...
extern WINAPI "odbc32.dll" {
	SQLRETURN SQLBrowseConnect(SQLHDBC hdbc,dword szConnStrIn,SQLSMALLINT cbConnStrIn,
	...
	SQLRETURN SQLColumnPrivileges(SQLHSTMT hstmt,dword szCatalogName,SQLSMALLINT cbCatalogName,
	...
	SQLRETURN SQLDescribeParam(SQLHSTMT hstmt,SQLUSMALLINT ipar,dword pfSqlType,
		dword pcbParamDef,dword pibScale,dword pfNullable);
	SQLRETURN SQLExtendedFetch(SQLHSTMT hstmt,SQLUSMALLINT fFetchType,SQLROWOFFSET irow,
		dword pcrow,dword rgfRowStatus);
	SQLRETURN SQLForeignKeys(SQLHSTMT hstmt,dword szPkCatalogName,SQLSMALLINT cbPkCatalogName,
	...
	SQLRETURN SQLNativeSql(SQLHDBC hdbc,dword szSqlStrIn,SQLINTEGER cbSqlStrIn,
		dword szSqlStr,SQLINTEGER cbSqlStrMax,dword pcbSqlStr);
	SQLRETURN SQLNumParams(SQLHSTMT hstmt,dword pcpar);
	SQLRETURN SQLParamOptions(SQLHSTMT hstmt,SQLROWSETSIZE crow,dword pirow);
	SQLRETURN SQLPrimaryKeys(SQLHSTMT hstmt,dword szCatalogName,SQLSMALLINT cbCatalogName,
		dword szSchemaName,SQLSMALLINT cbSchemaName,dword szTableName,SQLSMALLINT cbTableName);
	SQLRETURN SQLProcedureColumns(SQLHSTMT hstmt,dword szCatalogName,SQLSMALLINT cbCatalogName,
		dword szSchemaName,SQLSMALLINT cbSchemaName,dword szProcName,SQLSMALLINT cbProcName,
		dword szColumnName,SQLSMALLINT cbColumnName);
	SQLRETURN SQLProcedures(SQLHSTMT hstmt,dword szCatalogName,SQLSMALLINT cbCatalogName,
		dword szSchemaName,SQLSMALLINT cbSchemaName,dword szProcName,SQLSMALLINT cbProcName);
	SQLRETURN SQLSetPos(SQLHSTMT hstmt,SQLSETPOSIROW irow,SQLUSMALLINT fOption,SQLUSMALLINT fLock);
	SQLRETURN SQLTablePrivileges(SQLHSTMT hstmt,dword szCatalogName,SQLSMALLINT cbCatalogName,
		dword szSchemaName,SQLSMALLINT cbSchemaName,dword szTableName,SQLSMALLINT cbTableName);
	SQLRETURN SQLDrivers(SQLHENV henv,SQLUSMALLINT fDirection,dword szDriverDesc,
	...
	SQLRETURN SQLBindParameter(SQLHSTMT hstmt,SQLUSMALLINT ipar,SQLSMALLINT fParamType,
		...
		SQLPOINTER rgbValue,SQLLEN cbValueMax,dword pcbValue);
#endif /* RC_INVOKED */
}
/*---------------------------------------------------------*/
...
#ifndef RC_INVOKED
extern WINAPI "odbc32.dll" {
	SQLRETURN  SQLAllocHandleStd(SQLSMALLINT fHandleType,SQLHANDLE hInput,dword phOutput);
}
#endif /* RC_INVOKED */
#endif
...
extern WINAPI "odbc32.dll" {
    ...
    SQLHSTMT hstmt,SQLUSMALLINT fConcurrency,SQLLEN crowKeyset,SQLUSMALLINT crowRowset);
...
struct ODBC_VS_ARGS{
	dword pguidEvent;	/* the GUID for event */
