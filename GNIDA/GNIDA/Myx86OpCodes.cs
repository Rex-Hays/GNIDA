...
namespace GNIDA
{
    public class Myx86OpCodes
    {
        ...
        public static readonly x86OpCode Mov_Eax_Dword = new x86OpCode("EAX =", new byte[] { 0xB8 }, 4, x86OperandType.Dword);                                                        
        ...
        public static readonly x86OpCode Retn = new x86OpCode("$RET", new byte[] { 0xC3 }, 0, x86OperandType.None);
