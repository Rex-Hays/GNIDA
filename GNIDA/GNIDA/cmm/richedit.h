...
#define FINDTEXTEXW	FINDTEXTEX
#define FINDTEXTEXA	FINDTEXTEX
...
#define	PFM_ALL PFM_STARTINDENT|PFM_RIGHTINDENT|PFM_OFFSET| \
				 PFM_ALIGNMENT|PFM_TABSTOPS|PFM_NUMBERING|PFM_OFFSETINDENT|PFM_RTLPARA
