...
#ifdef _WIN32
#define MMVERSION UINT  /* major (high byte), minor (low byte) */
#else
#define VERSION UINT    /* major (high byte), minor (low byte) */
#endif
#define MMRESULT UINT   /* error return code, 0 means no error */
...
#define MAKEFOURCC(ch0,ch1,ch2,ch3) ch3<<8+ch2<<8+ch1<<8+ch0
...
#ifdef _WIN32
	LRESULT CloseDriver(dword hDriver,LPARAM lParam1,LPARAM lParam2);
	dword OpenDriver(LPCWSTR szDriverName,LPCWSTR szSectionName,LPARAM lParam2);
	LRESULT SendDriverMessage(dword hDriver,UINT message,LPARAM lParam1,LPARAM lParam2);
	HMODULE DrvGetModuleHandle(dword hDriver);
	HMODULE GetDriverModuleHandle(dword hDriver);
	LRESULT DefDriverProc(DWORD_PTR dwDriverIdentifier,dword hdrvr,UINT uMsg,LPARAM lParam1,LPARAM lParam2);
#else
	LRESULT DrvClose(dword hdrvr, LPARAM lParam1, LPARAM lParam2);
	dword DrvOpen(LPCSTR szDriverName, LPCSTR szSectionName, LPARAM lParam2);
	LRESULT DrvSendMessage(dword hdrvr, UINT uMsg, LPARAM lParam1, LPARAM lParam2);
	HINSTANCE DrvGetModuleHandle(dword hdrvr);
	LRESULT DrvDefDriverProc(DWORD dwDriverIdentifier, dword hdrvr, UINT uMsg, LPARAM lParam1, LPARAM lParam2);
...
#endif
//typedef void (CALLBACK DRVCALLBACK)(dword hdrvr, UINT uMsg, DWORD_PTR dwUser, DWORD_PTR dw1, DWORD_PTR dw2);
...
#else
extern WINAPI "winmm.dll"{
	BOOL sndPlaySound(LPCSTR pszSound, UINT fuSound);
}
#endif
...
#ifdef _WIN32
#define sndAlias(ch0,ch1)      ch1<<8+ch0+SND_ALIAS_START
...
struct WAVEHDR{
  ...
  dword/*struct wavehdr_tag FAR * */lpNext;     /* reserved for driver */
...
#ifdef UNICODE
#define WAVEOUTCAPS WAVEOUTCAPSW
#else
...
#ifdef UNICODE
#define WAVEOUTCAPS2 WAVEOUTCAPS2W
#else
#define WAVEOUTCAPS2 WAVEOUTCAPS2A
#endif // UNICODE
...
#ifdef UNICODE
#define WAVEINCAPS2 WAVEINCAPS2W
#else
#define WAVEINCAPS2 WAVEINCAPS2A
#endif // UNICODE
...
extern WINAPI "winmm.dll"{
	...
	MMRESULT waveOutGetDevCapsA(dword uDeviceID,dword pwoc,UINT cbwoc);
	MMRESULT waveOutGetDevCapsW(dword uDeviceID,dword pwoc,UINT cbwoc);
#ifdef UNICODE
...
#else
	MMRESULT waveOutGetDevCaps(UINT uDeviceID,dword pwoc,UINT cbwoc);
#endif

	MMRESULT waveOutGetVolume(dword hwo,LPDWORD pdwVolume);
	MMRESULT waveOutSetVolume(dword hwo,DWORD dwVolume);
...
#define waveOutGetErrorText  waveOutGetErrorTextA
	...
	MMRESULT waveOutOpen(dword phwo,UINT uDeviceID,
    dword pwfx,DWORD_PTR dwCallback,DWORD_PTR dwInstance,DWORD fdwOpen);
	MMRESULT waveOutClose(dword hwo);
	MMRESULT waveOutPrepareHeader(dword hwo,dword pwh,UINT cbwh);
	MMRESULT waveOutUnprepareHeader(dword hwo,dword pwh,UINT cbwh);
	MMRESULT waveOutWrite(dword hwo,dword pwh,UINT cbwh);
	MMRESULT waveOutPause(dword hwo);
	MMRESULT waveOutRestart(dword hwo);
	MMRESULT waveOutReset(dword hwo);
	MMRESULT waveOutBreakLoop(dword hwo);
	MMRESULT waveOutGetPosition(dword hwo,dword pmmt,UINT cbmmt);
	MMRESULT waveOutGetPitch(dword hwo,LPDWORD pdwPitch);
	MMRESULT waveOutSetPitch(dword hwo,DWORD dwPitch);
	MMRESULT waveOutGetPlaybackRate(dword hwo,LPDWORD pdwRate);
	MMRESULT waveOutSetPlaybackRate(dword hwo,DWORD dwRate);
	MMRESULT waveOutGetID(dword hwo,dword puDeviceID);

#ifdef _WIN32
	MMRESULT waveOutMessage(dword hwo,UINT uMsg,DWORD_PTR dw1,DWORD_PTR dw2);
#else
	DWORD waveOutMessage(dword hwo,UINT uMsg,DWORD dw1,DWORD dw2);
#endif
	...
	MMRESULT waveInGetDevCapsA(dword uDeviceID,dword pwic,UINT cbwic);
	MMRESULT waveInGetDevCapsW(dword uDeviceID,dword pwic,UINT cbwic);
#ifdef UNICODE
...
#else
	MMRESULT waveInGetDevCaps(UINT uDeviceID,dword pwic,UINT cbwic);
#endif
...
#define waveInGetErrorText  waveInGetErrorTextA
	...
	MMRESULT waveInOpen(dword phwi,UINT uDeviceID,
    dword pwfx,DWORD_PTR dwCallback,DWORD_PTR dwInstance,DWORD fdwOpen);

	MMRESULT waveInClose(dword hwi);
	MMRESULT waveInPrepareHeader(dword hwi,dword pwh,UINT cbwh);
	MMRESULT waveInUnprepareHeader(dword hwi,dword pwh,UINT cbwh);
	MMRESULT waveInAddBuffer(dword hwi,dword pwh,UINT cbwh);
	MMRESULT waveInStart(dword hwi);
	MMRESULT waveInStop(dword hwi);
	MMRESULT waveInReset(dword hwi);
	MMRESULT waveInGetPosition(dword hwi,dword pmmt,UINT cbmmt);
	MMRESULT waveInGetID(dword hwi,dword puDeviceID);
	DWORD waveInMessage(dword hwi,UINT uMsg,DWORD dw1,DWORD dw2);
}
...
#define MEVT_EVENTTYPE(x)   x>>24
#define MEVT_EVENTPARM(x)   x&0x00FFFFFFL

#define MEVT_SHORTMSG       0x00    /* parm = shortmsg for midiOutShortMsg */
#define MEVT_TEMPO          0x01    /* parm = new tempo in microsec/qn     */
#define MEVT_NOP            0x02    /* parm = unused; does nothing         */

/* 0x04-0x7F reserved */

#define MEVT_LONGMSG        0x80    /* parm = bytes to send verbatim       */
#define MEVT_COMMENT        0x82    /* parm = comment data                 */
#define MEVT_VERSION        0x84    /* parm = MIDISTRMBUFFVER struct       */
...
extern WINAPI "winmm.dll"{
	...
	MMRESULT midiStreamOpen(dword phms,dword puDeviceID,DWORD cMidi,DWORD_PTR dwCallback,DWORD_PTR dwInstance,DWORD fdwOpen);
	MMRESULT midiStreamClose(dword hms);
	MMRESULT midiStreamProperty(dword hms,LPBYTE lppropdata,DWORD dwProperty);
	MMRESULT midiStreamPosition(dword hms,dword lpmmt,UINT cbmmt);
	MMRESULT midiStreamOut(dword hms,dword pmh,UINT cbmh);
	MMRESULT midiStreamPause(dword hms);
	MMRESULT midiStreamRestart(dword hms);
	MMRESULT midiStreamStop(dword hms);
#ifdef _WIN32
	MMRESULT midiConnect(dword hmi,dword hmo,LPVOID pReserved);
	MMRESULT midiDisconnect(dword hmi,dword hmo,LPVOID pReserved);
#endif

#ifdef _WIN32

	MMRESULT midiOutGetDevCapsA(dword uDeviceID,dword pmoc,UINT cbmoc);
	MMRESULT midiOutGetDevCapsW(dword uDeviceID,dword pmoc,UINT cbmoc);
#ifdef UNICODE
...
#else
	MMRESULT midiOutGetDevCaps(UINT uDeviceID,dword pmoc,UINT cbmoc);
#endif

	MMRESULT midiOutGetVolume(dword hmo,LPDWORD pdwVolume);
	MMRESULT midiOutSetVolume(dword hmo,DWORD dwVolume);
...
#define midiOutGetErrorText  midiOutGetErrorTextA
	...
	MMRESULT midiOutOpen(dword phmo,UINT uDeviceID,
    DWORD_PTR dwCallback,DWORD_PTR dwInstance,DWORD fdwOpen);
	MMRESULT midiOutClose(dword hmo);
	MMRESULT midiOutPrepareHeader(dword hmo,dword pmh,UINT cbmh);
	MMRESULT midiOutUnprepareHeader(dword hmo,dword pmh,UINT cbmh);
	MMRESULT midiOutShortMsg(dword hmo,DWORD dwMsg);
	MMRESULT midiOutLongMsg(dword hmo,dword pmh,UINT cbmh);
	MMRESULT midiOutReset(dword hmo);
	MMRESULT midiOutCachePatches(dword hmo,UINT uBank,LPWORD pwpa,UINT fuCache);
	MMRESULT midiOutCacheDrumPatches(dword hmo,UINT uPatch,LPWORD pwkya,UINT fuCache);
	MMRESULT midiOutGetID(dword hmo,dword puDeviceID);

#ifdef _WIN32
	MMRESULT midiOutMessage(dword hmo,UINT uMsg,DWORD_PTR dw1,DWORD_PTR dw2);
#else
	DWORD midiOutMessage(dword hmo,UINT uMsg,DWORD dw1,DWORD dw2);
#endif
	...
	MMRESULT midiInGetDevCapsA(dword uDeviceID,dword pmic,UINT cbmic);
	MMRESULT midiInGetDevCapsW(dword uDeviceID,dword pmic,UINT cbmic);
#ifdef UNICODE
...
#else
	MMRESULT midiInGetDevCaps(UINT uDeviceID,dword pmic,UINT cbmic);
	MMRESULT midiInGetErrorText(MMRESULT mmrError,LPSTR pszText,UINT cchText);
#endif

	MMRESULT midiInOpen(dword phmi,UINT uDeviceID,
        DWORD_PTR dwCallback,DWORD_PTR dwInstance,DWORD fdwOpen);
	MMRESULT midiInClose(dword hmi);
	MMRESULT midiInPrepareHeader(dword hmi,dword pmh,UINT cbmh);
	MMRESULT midiInUnprepareHeader(dword hmi,dword pmh,UINT cbmh);
	MMRESULT midiInAddBuffer(dword hmi,dword pmh,UINT cbmh);
	MMRESULT midiInStart(dword hmi);
	MMRESULT midiInStop(dword hmi);
	MMRESULT midiInReset(dword hmi);
	MMRESULT midiInGetID(dword hmi,dword puDeviceID);
	DWORD midiInMessage(dword hmi,UINT uMsg,DWORD dw1,DWORD dw2);
}
...
extern WINAPI "winmm.dll"{
	...
	MMRESULT auxGetDevCapsA(dword uDeviceID,dword pac,UINT cbac);
	MMRESULT auxGetDevCapsW(dword uDeviceID,dword pac,UINT cbac);
#ifdef UNICODE
...
#else
	MMRESULT auxGetDevCaps(UINT uDeviceID,dword pac,UINT cbac);
#endif
	MMRESULT auxSetVolume(UINT uDeviceID,DWORD dwVolume);
	MMRESULT auxGetVolume(UINT uDeviceID,LPDWORD pdwVolume);
	DWORD auxOutMessage(UINT uDeviceID,UINT uMsg,DWORD dw1,DWORD dw2);
}
...
extern WINAPI "winmm.dll"{
#ifdef _WIN32
	MMRESULT mixerGetDevCapsA(dword uMxId,dword pmxcaps,UINT cbmxcaps);
	MMRESULT mixerGetDevCapsW(dword uMxId,dword pmxcaps,UINT cbmxcaps);
#ifdef UNICODE
...
#endif // !UNICODE
#else
	MMRESULT mixerGetDevCaps(UINT uMxId,dword pmxcaps,UINT cbmxcaps);
#endif
	MMRESULT mixerOpen(dword phmx,UINT uMxId,DWORD_PTR dwCallback,DWORD_PTR dwInstance,DWORD fdwOpen);
	MMRESULT mixerClose(dword hmx);
	DWORD mixerMessage(dword hmx,UINT uMsg,DWORD_PTR dwParam1,DWORD_PTR dwParam2);
}
#ifdef _WIN32
struct MIXERLINEA {
...
extern WINAPI "winmm.dll"{
#ifdef _WIN32
	MMRESULT mixerGetLineInfoA(dword hmxobj,dword pmxl,DWORD fdwInfo);
	MMRESULT mixerGetLineInfoW(dword hmxobj,dword pmxl,DWORD fdwInfo);
#ifdef UNICODE
...
#endif // !UNICODE
#else
	MMRESULT mixerGetLineInfo(dword hmxobj,dword pmxl,DWORD fdwInfo);
#endif
...
#define MIXER_GETLINEINFOF_QUERYMASK        0x0000000FL
	MMRESULT mixerGetID(dword hmxobj,dword puMxId,DWORD fdwId);
}
...
struct MIXERLINECONTROLS{
  ...
  dword pamxctrl;       /* pointer to first MIXERCONTROL array */
};
#define MIXERLINECONTROLSW MIXERLINECONTROLS
#define MIXERLINECONTROLSA MIXERLINECONTROLS

extern WINAPI "winmm.dll"{
#ifdef _WIN32
	MMRESULT mixerGetLineControlsA(dword hmxobj,dword pmxlc,DWORD fdwControls);
	MMRESULT mixerGetLineControlsW(dword hmxobj,dword pmxlc,DWORD fdwControls);
#ifdef UNICODE
...
#endif // !UNICODE
#else
	MMRESULT mixerGetLineControls(dword hmxobj,dword pmxlc,DWORD fdwControls);
#endif
}
...
extern WINAPI "winmm.dll"{
#ifdef _WIN32
	MMRESULT mixerGetControlDetailsA(dword hmxobj,dword pmxcd,DWORD fdwDetails);
	MMRESULT mixerGetControlDetailsW(dword hmxobj,dword pmxcd,DWORD fdwDetails);
#ifdef UNICODE
...
#endif // !UNICODE
#else
	MMRESULT mixerGetControlDetails(dword hmxobj,dword pmxcd,DWORD fdwDetails);
#endif
...
#define MIXER_GETCONTROLDETAILSF_QUERYMASK  0x0000000FL
	...
	MMRESULT mixerSetControlDetails(dword hmxobj,dword pmxcd,DWORD fdwDetails);
}
...
extern WINAPI "winmm.dll"{
	MMRESULT timeGetSystemTime(dword pmmt,UINT cbmmt);
	DWORD timeGetTime(void);
	MMRESULT timeSetEvent(UINT uDelay,UINT uResolution,
    dword fptc,DWORD_PTR dwUser,UINT fuEvent);
MMRESULT timeKillEvent(UINT uTimerID);
MMRESULT timeGetDevCaps(dword ptc,UINT cbtc);
...
#ifdef _WIN32
	MMRESULT joyGetDevCapsA(dword uJoyID,dword pjc,UINT cbjc);
	MMRESULT joyGetDevCapsW(dword uJoyID,dword pjc,UINT cbjc);
#ifdef UNICODE
...
#endif // !UNICODE
#else
	MMRESULT joyGetDevCaps(UINT uJoyID,dword pjc,UINT cbjc);
#endif
	MMRESULT joyGetPos(UINT uJoyID,dword pji);
	MMRESULT joyGetPosEx(UINT uJoyID,dword pji);

	MMRESULT joyGetThreshold(UINT uJoyID,dword puThreshold);
...
/* MMIO data types */
#define FOURCC dword         /* a four character code */
...
struct MMIOINFO
{
  ...
  dword      pIOProc;        /* pointer to I/O procedure */
  ...
  dword           hmmio;          /* handle to open file */
};
...
#endif // !UNICODE
	dword mmioInstallIOProcA(FOURCC fccIOProc,dword pIOProc,DWORD dwFlags);
	dword mmioInstallIOProcW(FOURCC fccIOProc,dword pIOProc,DWORD dwFlags);
#ifdef UNICODE
#define mmioInstallIOProc  mmioInstallIOProcW
#else
#define mmioInstallIOProc  mmioInstallIOProcA
#endif // !UNICODE
	dword mmioOpenA(LPSTR pszFileName,dword pmmioinfo,DWORD fdwOpen);
	dword mmioOpenW(LPWSTR pszFileName,dword pmmioinfo,DWORD fdwOpen);
#ifdef UNICODE
#define mmioOpen  mmioOpenW
#else
#define mmioOpen  mmioOpenA
#endif // !UNICODE
	MMRESULT mmioRenameA(LPCSTR pszFileName, LPCSTR pszNewFileName,dword pmmioinfo,DWORD fdwRename);
	MMRESULT mmioRenameW(LPCWSTR pszFileName,LPCWSTR pszNewFileName,dword pmmioinfo,DWORD fdwRename);
#ifdef UNICODE
...
#define mmioRename  mmioRenameA
	...
	dword mmioInstallIOProc(FOURCC fccIOProc,dword pIOProc,DWORD dwFlags);
	dword mmioOpen(LPSTR pszFileName,dword pmmioinfo,DWORD fdwOpen);
	MMRESULT mmioRename(LPCSTR pszFileName,LPCSTR pszNewFileName,dword pmmioinfo,DWORD fdwRename);
#endif
	MMRESULT mmioClose(dword hmmio,UINT fuClose);
	LONG mmioRead(dword hmmio,HPSTR pch,LONG cch);
	LONG mmioWrite(dword hmmio,dword pch,LONG cch);
	LONG mmioSeek(dword hmmio,LONG lOffset,iOrigin);
	MMRESULT mmioGetInfo(dword hmmio,dword pmmioinfo,UINT fuInfo);
	MMRESULT mmioSetInfo(dword hmmio,dword pmmioinfo,UINT fuInfo);
	MMRESULT mmioSetBuffer(dword hmmio,LPSTR pchBuffer,LONG cchBuffer,UINT fuBuffer);
	MMRESULT mmioFlush(dword hmmio,UINT fuFlush);
	MMRESULT mmioAdvance(dword hmmio,dword pmmioinfo,UINT fuAdvance);
	LRESULT mmioSendMessage(dword hmmio,UINT uMsg,LPARAM lParam1,LPARAM lParam2);
	MMRESULT mmioDescend(dword hmmio,dword pmmcki,dword pmmckiParent,UINT fuDescend);
	MMRESULT mmioAscend(dword hmmio,dword pmmcki,UINT fuAscend);
	MMRESULT mmioCreateChunk(dword hmmio,dword pmmcki,UINT fuCreate);
}
...
#define _MCIERROR_
#define MCIERROR dword       /* error return code, 0 means no error */
#endif

#ifndef _MCIDEVICEID_           /* Same with MCIDEVICEID */
#define _MCIDEVICEID_
#define MCIDEVICEID unsigned int    /* MCI device ID type */
#endif
...
#endif // !UNICODE
#else
	MCIERROR mciSendCommand(MCIDEVICEID mciId,UINT uMsg,DWORD dwParam1,DWORD dwParam2);
	MCIERROR mciSendString(LPCSTR lpstrCommand,LPSTR lpstrReturnString,UINT uReturnLength,HWND hwndCallback);
	MCIDEVICEID mciGetDeviceID(LPCSTR pszDevice);
	BOOL mciGetErrorString(MCIERROR mcierr,LPSTR pszText,UINT cchText);
#endif
...
#define MCI_MSF_MINUTE(msf)             msf&0xff
#define MCI_MSF_SECOND(msf)             msf>>8&0xff
#define MCI_MSF_FRAME(msf)              msf>>16&0xff
#define MCI_MAKE_MSF(m,s,f)             f<<8+s<<8+m
#define MCI_TMSF_TRACK(tmsf)            tmsf&0xff
#define MCI_TMSF_MINUTE(tmsf)           tmsf>>8&0xff
#define MCI_TMSF_SECOND(tmsf)           tmsf>>16&0xff
#define MCI_TMSF_FRAME(tmsf)            tmsf>>24&0xff
#define MCI_MAKE_TMSF(t,m,s,f)          f<<8+s<<8+m<<8+t
#define MCI_HMS_HOUR(hms)               hms&0xff
#define MCI_HMS_MINUTE(hms)             hms>>8&0xff
#define MCI_HMS_SECOND(hms)             hms>>16&0xFF
#define MCI_MAKE_HMS(h,m,s)             s<<8+m<<8+h
...
#define MCI_OPEN_PARMSW MCI_OPEN_PARMS
#define MCI_OPEN_PARMSA MCI_OPEN_PARMS
...
#define MCI_INFO_PARMSW MCI_INFO_PARMS
#define MCI_INFO_PARMSA MCI_INFO_PARMS
...
#define MCI_SYSINFO_PARMSW MCI_SYSINFO_PARMS
#define MCI_SYSINFO_PARMSA MCI_SYSINFO_PARMS
#else
struct MCI_SYSINFO_PARMS {
  DWORD   dwCallback;
  LPSTR   lpstrReturn;
...
struct MCI_SAVE_PARMS{
  DWORD_PTR    dwCallback;
  LPCSTR       lpfilename;
};
#define MCI_SAVE_PARMSW MCI_SAVE_PARMS
#define MCI_SAVE_PARMSA MCI_SAVE_PARMS

/* parameter block for MCI_LOAD command message */
struct MCI_LOAD_PARMS{
  DWORD_PTR    dwCallback;
  LPCSTR       lpfilename;
};
#define MCI_LOAD_PARMSW MCI_LOAD_PARMS
#define MCI_LOAD_PARMSA MCI_LOAD_PARMS
...
struct MCI_VD_ESCAPE_PARMS{
  DWORD_PTR   dwCallback;
  LPCSTR      lpstrCommand;
};
#define MCI_VD_ESCAPE_PARMSW MCI_VD_ESCAPE_PARMS
#define MCI_VD_ESCAPE_PARMSA MCI_VD_ESCAPE_PARMS
...
#define MCI_WAVE_OPEN_PARMSW MCI_WAVE_OPEN_PARMS
#define MCI_WAVE_OPEN_PARMSA MCI_WAVE_OPEN_PARMS
...
#define MCI_ANIM_OPEN_PARMSW MCI_ANIM_OPEN_PARMS
#define MCI_ANIM_OPEN_PARMSA MCI_ANIM_OPEN_PARMS
...
#define MCI_ANIM_WINDOW_PARMSW MCI_ANIM_WINDOW_PARMS
#define MCI_ANIM_WINDOW_PARMSA MCI_ANIM_WINDOW_PARMS
...
#define MCI_OVLY_OPEN_PARMSW MCI_OVLY_OPEN_PARMS
#define MCI_OVLY_OPEN_PARMSA MCI_OVLY_OPEN_PARMS
...
/* parameter block for MCI_WINDOW command message */
#ifdef _WIN32
struct MCI_OVLY_WINDOW_PARMS{
  DWORD_PTR   dwCallback;
  HWND        hWnd;
  UINT        nCmdShow;
  LPCSTR      lpstrText;
};
#define MCI_OVLY_WINDOW_PARMSW MCI_OVLY_WINDOW_PARMS
#define MCI_OVLY_WINDOW_PARMSA MCI_OVLY_WINDOW_PARMS
#else
struct MCI_OVLY_WINDOW_PARMS {
  DWORD   dwCallback;
  HWND    hWnd;
...
/* parameter block for MCI_SAVE command message */
struct MCI_OVLY_SAVE_PARMS{
  DWORD_PTR   dwCallback;
  LPCSTR      lpfilename;
  RECT        rc;
};
#define MCI_OVLY_SAVE_PARMSW MCI_OVLY_SAVE_PARMS
#define MCI_OVLY_SAVE_PARMSA MCI_OVLY_SAVE_PARMS

/* parameter block for MCI_LOAD command message */
struct MCI_OVLY_LOAD_PARMS{
  DWORD_PTR   dwCallback;
  LPCSTR      lpfilename;
  RECT    rc;
};
#define MCI_OVLY_LOAD_PARMSW MCI_OVLY_LOAD_PARMS
#define MCI_OVLY_LOAD_PARMSA MCI_OVLY_LOAD_PARMS
