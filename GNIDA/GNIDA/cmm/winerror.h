...
#define IS_ERROR(Status) (Status>>31 == SEVERITY_ERROR)
...
//  Return the severity
#define HRESULT_SEVERITY(hr)  hr>>31
#define SCODE_SEVERITY(sc)    sc>>31

// Create an HRESULT value from component pieces
#define MAKE_HRESULT(sev,fac,code) sev<<15|fac<<16+code
#define MAKE_SCODE(sev,fac,code) sev<<15|fac<<16+code
...
inline fastcall HRESULT_FROM_WIN32(EAX)
{
	IF(long EAX>0){
		$push EDX
		EDX=FACILITY_WIN32<<16|0x80000000;
		EAX=EAX&0x0000FFFF|EDX;
		$pop EDX
	}
}
...
#define EVENT_E_CANT_MODIFY_OR_DELETE_CONFIGURED_OBJECT 0x8004020EL
...
#define XACT_E_UNKNOWNRMGRID             0x8004D010L
...
#define CRYPT_I_NEW_PROTECTION_REQUIRED  0x00091012L
...
// MessageText:
//  REMOVE THIS ERROR
#define COMADMIN_E_CAT_DUPLICATE_PARTITION_SET_NAME 0x80110900L

// MessageId: COMADMIN_E_CAT_INVALID_PARTITION_SET_NAME
// MessageText:
//  REMOVE THIS ERROR
#define COMADMIN_E_CAT_INVALID_PARTITION_SET_NAME 0x80110901L
