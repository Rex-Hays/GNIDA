...
inline stdcall SEND_DGVSIGNAL(dwFlags,dwCallback,hDriver,wDeviceID,dwUser,dwPos )
uses EBX ECX
{
	EBX=dwPos;
	ECX=dwUser;
	IF(!$test dwFlags,MCI_DGV_SIGNAL_POSITION)EBX><ECX;
  DriverCallback(dwCallback,DCB_WINDOW,wDeviceID,MM_MCISIGNAL,hDriver,EBX,ECX);
}
...
#define MCI_DGV_CAPTURE_PARMSW MCI_DGV_CAPTURE_PARMS
#define MCI_DGV_CAPTURE_PARMSA MCI_DGV_CAPTURE_PARMS
...
struct MCI_DGV_INFO_PARMS{
  DWORD_PTR   dwCallback;
  LPSTR   lpstrReturn;
  DWORD   dwRetSize;
  DWORD   dwItem;
};
#define MCI_DGV_INFO_PARMSW MCI_DGV_INFO_PARMS
#define MCI_DGV_INFO_PARMSA MCI_DGV_INFO_PARMS

/* parameter block for MCI_LIST command message */
struct MCI_DGV_LIST_PARMS{
  DWORD_PTR   dwCallback;
  LPSTR   lpstrReturn;
  DWORD   dwLength;
  DWORD   dwNumber;
...
#define MCI_DGV_LIST_PARMSW MCI_DGV_LIST_PARMS
#define MCI_DGV_LIST_PARMSA MCI_DGV_LIST_PARMS
...
#define MCI_DGV_OPEN_PARMSW MCI_DGV_OPEN_PARMS
#define MCI_DGV_OPEN_PARMSA MCI_DGV_OPEN_PARMS
...
#define MCI_DGV_QUALITY_PARMSW MCI_DGV_QUALITY_PARMS
#define MCI_DGV_QUALITY_PARMSA MCI_DGV_QUALITY_PARMS
...
struct MCI_DGV_RESERVE_PARMS{
  DWORD_PTR   dwCallback;
  LPSTR   lpstrPath;
  DWORD   dwSize;
};
#define MCI_DGV_RESERVE_PARMSW MCI_DGV_RESERVE_PARMS
#define MCI_DGV_RESERVE_PARMSA MCI_DGV_RESERVE_PARMS

/* parameter block for MCI_RESTORE command message */
struct MCI_DGV_RESTORE_PARMS{
  DWORD_PTR   dwCallback;
  LPSTR   lpstrFileName;
#ifdef MCI_USE_OFFEXT
  POINT   ptOffset;
...
#define MCI_DGV_RESTORE_PARMSW MCI_DGV_RESTORE_PARMS
#define MCI_DGV_RESTORE_PARMSA MCI_DGV_RESTORE_PARMS

/* parameter block for MCI_RESUME command message */
//typedef MCI_GENERIC_PARMS MCI_DGV_RESUME_PARMS;
/* parameter block for MCI_SAVE command message */
struct MCI_DGV_SAVE_PARMS{
  DWORD_PTR   dwCallback;
  LPSTR   lpstrFileName;
  RECT    rc;
};
#define MCI_DGV_SAVE_PARMSW MCI_DGV_SAVE_PARMS
#define MCI_DGV_SAVE_PARMSA MCI_DGV_SAVE_PARMS
...
#define MCI_DGV_SETAUDIO_PARMSW MCI_DGV_SETAUDIO_PARMS
#define MCI_DGV_SETAUDIO_PARMSA MCI_DGV_SETAUDIO_PARMS
...
#define MCI_DGV_SETVIDEO_PARMSW MCI_DGV_SETVIDEO_PARMS
#define MCI_DGV_SETVIDEO_PARMSA MCI_DGV_SETVIDEO_PARMS
...
#define MCI_DGV_STATUS_PARMSW MCI_DGV_STATUS_PARMS
#define MCI_DGV_STATUS_PARMSA MCI_DGV_STATUS_PARMS
...
#define MCI_DGV_WINDOW_PARMSW MCI_DGV_WINDOW_PARMS
#define MCI_DGV_WINDOW_PARMSA MCI_DGV_WINDOW_PARMS
